...
{
    public static final String EXTRA_HIDELOG = "com.ayothayavpn.sockshttp.showNoLogWindow";
    ...
    private void askForPW(final int type) {
        ...
        ((ImageButton) userpwlayout.findViewById(R.id.show_password)).setOnClickListener(new OnClickListener() {
                @Override
    ...
    private void showLogWindow() {
        Intent updateView = new Intent("com.ayothayavpn.sockshttp:openLogs");
