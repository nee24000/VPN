package com.zennetvpn.ShanDevzService.config;

import android.content.Context;
import android.content.SharedPreferences;
import android.preference.PreferenceManager;
import com.zennetvpn.ShanDevzService.util.securepreferences.SecurePreferences;
import com.zennetvpn.ShanDevzService.util.securepreferences.model.SecurityConfig;
...
public class Settings implements SettingsConstants
{
	...
	*/
	...
	public int getMaximoThreadsSocks() {
		String n = mPrefs.getString(MAXIMO_THREADS_KEY, "25th");
		if (n == null || n.isEmpty()) {
			n = "25th";
		}
	...
	public boolean getHideLog() {
		return mPrefs.getBoolean(HIDE_LOG_KEY, true);
	}
	...
	*/
	...
	public String getVpnDnsResolver(){
		return mPrefs.getString(DNSRESOLVER_KEY, "208.67.222.222");
	}
	...
	*/
	...
	public static void setDefaultConfig(Context context){
		...
		editor.putString(DNSRESOLVER_KEY, "208.67.222.222");
		...
		editor.putBoolean(HIDE_LOG_KEY, true);
