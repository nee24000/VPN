...
public final class AESCrypt {
     ...
     * Decrypt and decode ciphertext using 256-bit AES with key generated from password
     *
     * เวอร์ชันนี้ “ปิดระบบเข้ารหัส” โดยจะคืนค่าเดิมกลับไปเลย
     * ดังนั้น base64EncodedCipherText ต้องเป็น JSON ดิบๆ อยู่แล้ว
     */
    public static String decrypt(final String password, String base64EncodedCipherText)
            throws GeneralSecurityException {

        // ถ้าอยาก debug ดูค่า JSON ที่รับมาก็เปิด DEBUG_LOG_ENABLED = true
        if (DEBUG_LOG_ENABLED) {
            Log.d(TAG, "decrypt() called, returning plain text: " + base64EncodedCipherText);
        }

        // ไม่ต้องถอดรหัสอะไรทั้งนั้น ใช้ข้อความเดิมตรงๆ
